	...
	return (
		<>
			<div className='flex flex-col xl:flex-row grow'>
				...
				<div className='lg:pl-[4.375rem] xl:pl-[10dvw] xl:pt-[calc(40dvh+1.875rem)]'>
					<div className='font-primary font-light text-[2.5rem] text-white'>Got an idea or just like to talk?</div>
